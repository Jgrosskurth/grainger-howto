...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'search-inline-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'search-inline-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-inline-results');
...
function searchBox(block, config) {
  ...
  box.classList.add('search-inline-box');
  box.append(
    searchIcon(),
...
export default async function decorate(block) {
  const placeholders = { searchPlaceholder: 'Search', searchNoResults: 'No results found.' };
  ...
  if (authoredHeading) {
    ...
    title.className = 'search-inline-title';
    title.textContent = authoredHeading.textContent;
  }
  block.innerHTML = '';
